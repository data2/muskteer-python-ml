...
request_urls = [
    'https://list.youku.com/category/page?c=96&pt=&r=&type=show&p=1',
    'https://list.youku.com/category/page?c=96&pt=&r=&type=show&p=2',
    'https://list.youku.com/category/page?c=96&pt=&r=&type=show&p=3',
    'https://list.youku.com/category/page?c=96&pt=&r=&type=show&p=4',
    'https://list.youku.com/category/page?c=96&pt=&r=&type=show&p=5',
    'https://list.youku.com/category/page?c=96&pt=&r=&type=show&p=6',
    'https://list.youku.com/category/page?c=96&pt=&r=&type=show&p=7',
    'https://list.youku.com/category/page?c=96&pt=&r=&type=show&p=8',
    'https://list.youku.com/category/page?c=96&pt=&r=&type=show&p=9',
    'https://list.youku.com/category/page?c=96&pt=&r=&type=show&p=10',
    'https://list.youku.com/category/page?c=96&pt=&r=&type=show&p=11',
    'https://list.youku.com/category/page?c=96&pt=&r=&type=show&p=12',
    'https://list.youku.com/category/page?c=96&pt=&r=&type=show&p=13',
    'https://list.youku.com/category/page?c=96&pt=&r=&type=show&p=14',
    'https://list.youku.com/category/page?c=96&pt=&r=&type=show&p=15',
    'https://list.youku.com/category/page?c=96&pt=&r=&type=show&p=16',
    'https://list.youku.com/category/page?c=96&pt=&r=&type=show&p=17']

for url in request_urls:
    res = requests.get(url, req_headers).json()
    print(res['success'])
    with open('youku.txt', "a") as file:
        for data in res['data']:
            try:
                param = {'name': data['title'], 'playUrl': 'http://'+data['videoLink'][2:],
                         'imageUrl': 'http://'+data['img'][2:], 'focus': data['subTitle'],
                         'free': data['access'] == 'allow', 'from': 'youku', 'extend': {}}
                print(str(param))
