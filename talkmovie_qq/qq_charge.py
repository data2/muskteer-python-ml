...
while i <= 168:
    print(i)
    request_urls.append('https://v.qq.com/x/bu/pagesheet/list?_all=1&append=0&channel=movie&charge=2&listpage=2&offset='
...
while i <= 6:
    print(i)
    request_urls.append('https://v.qq.com/x/bu/pagesheet/list?_all=1&append=0&channel=movie&charge=3&listpage=2&offset='
                        + str(i*30) + '&pagesize=30&sort=18')
    request_urls.append('https://v.qq.com/x/bu/pagesheet/list?_all=1&append=0&channel=movie&charge=4&listpage=2&offset='
                        + str(i*30) + '&pagesize=30&sort=18')
    i = i + 1
...
for url in request_urls:
    ...
    for film in filmList:
        try:
            with open('qq_charge.txt', "a") as file:
