...
request_urls = []
with open('collect_film_name.txt') as file:
    for line in file:
        try:
            print(line)
            request_urls.append('https://baike.baidu.com/item/' + line)
...
for url in request_urls:
    ...
    try:
        ...
        print(soup.find_all(class_='poster-top'))
        with open('baidu.txt', "a") as file:
            file.write('')
        file.close()
    except Exception as e:
        print('异常')
